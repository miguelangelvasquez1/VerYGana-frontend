...
interface PlanLockedSectionProps {
  ...
  message: string;
  className?: string;
  /** Destino del CTA. Por defecto el catálogo de planes. */
  ctaHref?: string;
  ctaLabel?: string;
}
...
export function PlanLockedSection({
  ...
  return (
    ...
    >
      ...
      <Link
        href={ctaHref}
        className="mt-4 inline-flex items-center gap-1.5 rounded-lg bg-[#03548C] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#0b1440]"
      >
