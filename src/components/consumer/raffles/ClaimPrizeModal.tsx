        ...
        <div className="px-6 py-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-5 border-2 border-gray-200 rounded-2xl hover:border-blue-500 hover:bg-blue-50 transition-all group"
                  >
                    <span className="text-3xl">📧</span>
                    <span className="font-semibold text-sm text-gray-700 group-hover:text-blue-700">
                      Correo electrónico
                    </span>
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-5 border-2 border-gray-200 rounded-2xl hover:border-green-500 hover:bg-green-50 transition-all group"
                  >
                    <span className="text-3xl">📱</span>
                    <span className="font-semibold text-sm text-gray-700 group-hover:text-green-700">
                      Mensaje de texto
                    </span>
                    <span className="text-xs text-gray-400 text-center">
            ...
            <div className="space-y-5">
              ...
              >
                <div className={`mt-0.5 w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${
                  !useCustomEmail ? "border-blue-500" : "border-gray-400"
                }`}>
                  {!useCustomEmail && <div className="w-2 h-2 rounded-full bg-blue-500" />}
                </div>
                <div>
                  <p className="font-semibold text-sm text-gray-800">Usar mi correo registrado</p>
                  <p className="text-sm text-blue-600 font-mono mt-0.5">{registeredEmail}</p>
          ...
          {step === "sms-contact" && (
            <div className="space-y-5">
              ...
              >
                <div className={`mt-0.5 w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${
                  !useCustomPhone ? "border-green-500" : "border-gray-400"
                }`}>
                  {!useCustomPhone && <div className="w-2 h-2 rounded-full bg-green-500" />}
                </div>
                <div>
                  <p className="font-semibold text-sm text-gray-800">
                    Usar mi número de teléfono registrado
                  </p>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Requiere verificación con código SMS
                  </p>
                </div>
              </button>
              ...
              <div className="bg-green-50 border border-green-100 rounded-xl p-3 flex gap-2">
                <span className="text-green-600 text-sm shrink-0">ℹ️</span>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 text-xl font-mono text-center tracking-[0.4em] focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  autoFocus
                />
              </div>
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  disabled={loading}
                  className="text-sm text-green-600 hover:text-green-700 font-semibold underline disabled:opacity-50"
                >
                  Reenviar código
                </button>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 flex gap-2">
                <span className="text-amber-500 text-sm shrink-0">⏱️</span>
                <p className="text-xs text-amber-700">
                  El código expira en pocos minutos. Si no lo ves, revisa que el número
                  sea correcto o intenta reenviar.
                </p>
              </div>
