  ...
  return (
    ...
    >
      ...
      {cartSummary.itemCount > 0 && (
        <span className="absolute -top-1 -right-1 bg-[#00a4ff] text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center animate-in zoom-in-50">
