    ...
    <div className="w-full">
      <div className="flex items-center gap-2 mb-2">
        ...
        <input
          ...
          maxLength={7}
          disabled={readonly || disabled}
          className="flex-1 min-w-0 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-violet-500 focus:border-violet-500 disabled:bg-gray-100 disabled:cursor-not-allowed font-mono text-sm"
        />
        ...
        <button
          ...
          onClick={handleCopy}
          disabled={readonly || disabled}
          className="flex-shrink-0 h-10 w-10 flex items-center justify-center bg-gray-100 hover:bg-gray-200 rounded-md border border-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          title="Copiar color"
        >
          {copied ? (
