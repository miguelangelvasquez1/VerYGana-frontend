    ...
    <div className="w-full">
      <div className="relative mb-2">
        <input
          ...
          className="w-full px-3 py-2 pr-8 border border-gray-300 rounded-md focus:ring-2 focus:ring-violet-500 focus:border-violet-500 disabled:bg-gray-100 disabled:cursor-not-allowed text-sm"
        />
        ...
        <div>
          {imageLoading && (
            <div className="flex items-center justify-center bg-gray-100 border border-gray-200 rounded-md h-24">
              <div className="text-center">
                <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-violet-600 mx-auto mb-1"></div>
          ...
          {!imageError && !imageLoading && (
            <div className="relative group">
              ...
              />
              <div className="absolute top-1 right-1 bg-violet-500 text-white text-xs px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                Preview
              </div>
            </div>
          )}
