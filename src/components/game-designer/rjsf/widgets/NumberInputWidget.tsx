    ...
    <div className="w-full space-y-1.5">
        ...
        <div className="relative flex-1">
          <input
            ...
            className={`
              ...
              ${isFocused ? 'ring-2 ring-violet-100 border-violet-500' : ''}
              ${disabled || readonly
      ...
      {isFocused && value !== undefined && value !== null && (
        <div className="text-xs">
          <span className="inline-flex items-center px-2 py-1 rounded-full bg-violet-100 text-violet-700 font-medium">
            Valor actual: {value}
          </span>
        </div>
      )}
