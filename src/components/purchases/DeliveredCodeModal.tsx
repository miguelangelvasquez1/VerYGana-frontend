      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-lg p-6">
        ...
        {!loading && !error && code && (
          <div className="space-y-3">
            ...
            <button
              onClick={handleCopy}
              className="cursor-pointer w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg text-sm hover:bg-gray-50 transition-colors"
            >
              {copied ? (
